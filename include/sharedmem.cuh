...
template <>
struct SharedMemory <Pixel<3u>>
{
    __device__ Pixel<3u> *getPointer()
    {
        extern __shared__ Pixel<3u> s_Pixel[];
        return s_Pixel;
    }
};
...
template <>
struct SharedMemory <Pixel<4u>>
{
    __device__ Pixel<4u> *getPointer()
    {
        extern __shared__ Pixel<4u> sPixel[];
        return sPixel;
    }
};
